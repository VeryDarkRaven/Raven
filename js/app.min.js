    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        function clickButton(direction) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                let startAnimResult = yield scrollAnimResult.start();
                let directionAnimResult = yield startAnimResult[direction]();
                if (directionAnimResult) {
                ...
                function clickButtonTransitionEnd() {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        hideInactiveButton();
                        let scrollAnimResult = yield (0,_screen_scroll_animation_js__WEBPACK_IMPORTED_MODULE_0__.scrollAnim)();
                        let startAnimResult = yield scrollAnimResult.end();
                        let directionAnimResult = yield startAnimResult[direction]();
                        if (directionAnimResult) {
                            buttonsList.forEach((item) => {
...
function scrollAnim() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const currectBlockPosition = (0,_screen_control_arrows_js__WEBPACK_IMPORTED_MODULE_1__.returnCurrectBlockPosition)(blocksPageObj);
