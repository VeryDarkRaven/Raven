...
function resizeToolbar(item) {
    ...
    let logBlock = document.querySelector("#log");
    logBlock.innerHTML = `
  item top: ${item.offsetTop}<br>
  item height: ${item.offsetHeight}<br>
...
function screenControlArrows(blocksPageObj) {
    ...
    function clickButton(direction) {
        ...
        function clickButtonTransitionEnd() {
            ...
            // resizeToolbar(newCurrectBlock);
            // if (newCurrectBlock === document.querySelector("[data-wrapper]").querySelectorAll(".wrapper__child")[document.querySelector("[data-wrapper]").querySelectorAll(".wrapper__child").length - 1]) {
            ...
            //     });
            //   }, {threshold: 0.5});
            //   observer.observe(newCurrectBlock);
            //   let resultBlock = document.querySelector("#scroll");
            //   resultBlock.innerHTML = `
            //   currect scroll: ${window.scrollY}<br>
            //   section top position: ${newCurrectBlock.offsetTop}<br>
            //   body scroll height: ${document.body.scrollHeight}<br>
            //   window: ${window.innerHeight}<br>
            //   body - window: ${document.body.scrollHeight - window.innerHeight}<br>
    ...
    function createMovementOptionsObj() {
        ...
        return {
            top: currectPosition[0] - 1 >= 0 && blocksPageObj.positionArr[currectPosition[0] - 1][currectPosition[1]] !== undefined ? true : false,
            right: currectPosition[1] + 1 < columnOfPageBlocksNum && blocksPageObj.positionArr[currectPosition[0]][currectPosition[1] + 1] !== undefined ? true : false,
            bottom: currectPosition[0] + 1 < rowsOfPageBlocksNum && blocksPageObj.positionArr[currectPosition[0] + 1][currectPosition[1]] !== undefined ? true : false,
            left: currectPosition[1] - 1 >= 0 && blocksPageObj.positionArr[currectPosition[0]][currectPosition[1] - 1] !== undefined ? true : false,
        };
    }
}
